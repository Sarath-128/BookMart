...
<h2 className='text-center text1'  data-aos="fade-up" data-aos-delay="300">User Details</h2>
...
<div className='table-responsive'  data-aos="fade-up" data-aos-delay="300">
    ...
    <table className=" table shadow tw" style={{backgroundColor: 'transparent'}}>
    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <form onSubmit={handleSubmit}>
            ...
            <input className='form-control' value={updateUser.name} name='name' onChange={handleInputChange}></input>

            <label><strong>Email</strong></label>
            <input className='form-control' value={updateUser.email} name='email' onChange={handleInputChange}></input>

            <label><strong>Phone</strong></label>
            <input className='form-control' value={updateUser.phone} name='phone' onChange={handleInputChange}></input>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={()=> handleDelete(updateUser.id)}>Delete</button>
      </div>
    </div>
  </div>
</div>
